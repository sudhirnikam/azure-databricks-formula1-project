...
USING csv
OPTIONS (path "abfss://raw@formula1dls7.dfs.core.windows.net/circuits.csv", header true)
...
url STRING)
USING csv
OPTIONS (path "abfss://raw@formula1dls7.dfs.core.windows.net/races.csv", header true)
...
url STRING)
USING json
OPTIONS(path "abfss://raw@formula1dls7.dfs.core.windows.net/constructors.json")
...
url STRING)
USING json
OPTIONS (path "abfss://raw@formula1dls7.dfs.core.windows.net/drivers.json")
...
statusId STRING)
USING json
OPTIONS(path "abfss://raw@formula1dls7.dfs.core.windows.net/results.json")
...
time STRING)
USING json
OPTIONS(path "abfss://raw@formula1dls7.dfs.core.windows.net/pit_stops.json", multiLine true)
...
USING csv
OPTIONS (path "abfss://raw@formula1dls7.dfs.core.windows.net/lap_times")
...
raceId INT)
USING json
OPTIONS (path "abfss://raw@formula1dls7.dfs.core.windows.net/qualifying", multiLine true)
